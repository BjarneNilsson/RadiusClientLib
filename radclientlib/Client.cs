...
#nullable enable
    {
        ...
        {
            _AClient.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            ...
            if (a.Password != null)
            {
                UserAvalable(this, new UserAvalableArgs(a.Name, a.Password, a.Vlan));
            }
            else { }
        }
